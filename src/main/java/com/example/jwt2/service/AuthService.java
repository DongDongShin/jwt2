...
import com.example.jwt2.controller.dto.*;
import com.example.jwt2.entity.Member;
import com.example.jwt2.entity.RefreshToken;
import com.example.jwt2.jwt.TokenProvider;
import com.example.jwt2.repository.MemberRepository;
import com.example.jwt2.repository.RefreshTokenRepository;
...
import static com.example.jwt2.entity.Authority.ROLE_USER;
...
public class AuthService {
    ...
    public ResponseDto<?> signup(MemberRequestDto memberRequestDto) {
        ...
        } else if (!memberRequestDto.getPassword2().equals(memberRequestDto.getPassword())) {
